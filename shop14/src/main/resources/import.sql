...
INSERT INTO products (PRODUCT_NAME, PRODUCT_PRICE, PRODUCT_IS_ACTIVE) values ('Neslte Kit-Kat white', 1.02, 'false');
...
insert into cards (NAME) values ('My cristmas products'); -- 1
